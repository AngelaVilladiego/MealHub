...
import { Squares2X2Icon, ListBulletIcon, StarIcon, UserIcon, ArrowRightStartOnRectangleIcon } from "@heroicons/react/24/outline";
        ...
        <aside id="nav-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen" role="navigation" aria-label="Main">
            <div class="flex flex-col h-full items-stretch px-3 py-4 overflow-y-auto bg-orange-500 text-white">
              ...
              <ul class="grow flex flex-col gap-y-2 text-lg">
                <li ><Link to="/" class="flex items-center p-2 font-bold rounded-lg hover:bg-orange-200 hover:text-gray-900 group">
                ...
                <li class="mt-auto"><Link to="/" class="flex items-center p-2 font-bold rounded-lg hover:bg-orange-200 hover:text-gray-900 group">
